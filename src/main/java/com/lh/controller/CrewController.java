...
public class CrewController {
    ...
    public ModelAndView toInfo(@RequestParam(value="loginId",required=false)String loginId){
        Crew crew = crewService.findById(loginId);
        Image image = imageService.findById(loginId);
        ...
        mav.setViewName("/admin/crewShowInfo");
        return mav;
    }
